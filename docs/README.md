...
<p align="center">
	<a href="https://github.com/MangDL/MangDL/blob/master/LICENSE.md">
...
For programmatic use, visit the documentation: [MangDL.github.io/docs](https://MangDL.github.io/docs)
